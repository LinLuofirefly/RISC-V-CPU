...
module forwarding (
    ...
    always @(*) begin
        ...
        // ---- 操作数 1 (rs1) ----
        if (use_rs1 && (rs1 != 5'b0) && ex_mem_rd_wen_i && (ex_mem_rd_addr_i == rs1)) begin
        ...
        // ---- 操作数 2 (rs2) ----
        if (use_rs2 && (rs2 != 5'b0) && ex_mem_rd_wen_i && (ex_mem_rd_addr_i == rs2)) begin
            // EX/MEM → EX 前递
        ...
        if (use_base_addr && (rs1 != 5'b0) && ex_mem_rd_wen_i && (ex_mem_rd_addr_i == rs1)) begin
